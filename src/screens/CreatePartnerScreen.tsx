...
import { View, Text, StyleSheet, TouchableOpacity, TextInput, Alert, Keyboard, TouchableWithoutFeedback, ScrollView, KeyboardAvoidingView, Platform, ActivityIndicator, Image, Animated, ActionSheetIOS } from 'react-native';
...
const CreatePartnerScreen: React.FC<CreatePartnerScreenProps> = ({ onBack, onPartnerCreated }) => {
  ...
  const handleCreatePartner = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Partner Created',
        `${partnerData.name} ${partnerData.lastname} has been added to your doubles partners.`,
        [
          {
            text: 'OK',
            onPress: () => {
